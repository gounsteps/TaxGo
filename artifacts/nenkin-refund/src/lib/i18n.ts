...
export const translations: TranslationStore = {
  ...
  en: {
    ...
    "process.4.desc": "Takes approximately 4 months or more",
    ...
    "process.6.desc": "Tax representative files the refund claim at the local tax office",
    "process.7.title": "Tax Refund Transfer",
    "process.7.desc": "Deposited directly into your bank account",
    "process.8.title": "Service Completion",
    "process.8.desc": "All procedures completed",
