...
export const translations: TranslationStore = {
  ...
  ja: {
    ...
    "process.6.desc": "還付申請完了まで約2ヶ月以上かかります。税務署への還付受付および処理完了時、お客様にご案内いたします",
  ...
  en: {
    ...
    "process.6.desc": "Refund processing takes 2+ months. We will notify you when the application is filed and when processing is complete",
